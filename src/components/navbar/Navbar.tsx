							...
							{menuItems.map((item) => (
								...
								>
									<div
										...
										onMouseEnter={(e) => {
											e.preventDefault();
											handleDesktopMenuItemsMouseOver(
												item.name,
											);
										}}
										onMouseLeave={
											handleDesktopMenuItemsMouseOut
										}
									>
										<Link
											href={item.path}
									...
									{desktopMenuItemHovered === item.name && (
										<div
											className={
												styles.desktopMenuItemPanel
											}
										>
											<div
												className={
													styles.desktopMenuItemPanelGrid
												}
											>
												<div
													className={
														styles.desktopMenuItemPanelColumn
													}
												>
													<h3>SHOP BY SIZE</h3>
													<ul>
												...
												>
													<Image
														...
														alt="Luggage image"
														className={
															styles.desktopMenuItemPanelFeaturedImage
														}
													></Image>
													<p
														className={
				...
				<div className={styles.menuItems}>
					{menuItems.map((item) => (
						<span
							...
							className={styles.menuItem}
							onClick={() =>
								handleMobileMenuItemsExpand(item.name)
							}
						>
							<div className={styles.mobileMenuItem}>
								...
								{mobileMenuItemExpanded === item.name && (
									<div
										className={
											styles.mobileMenuItemExpandablePanel
										}
									>
