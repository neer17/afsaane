		...
		const handleScroll = () => {
			if (textRef.current) {
				...
				if (previousScrollY.current !== null) {
					direction =
						currentScrollY > previousScrollY.current ? -1 : 1;
	...
	return (
		<div className={styles.wrapper}>
			<p ref={textRef} className={styles.scrollableText}>
				Your scrolling text here. Your scrolling text here. Your
				scrolling text here. Your scrolling text here. Your scrolling
				text here. Your scrolling text here. Your scrolling text here.
				Your scrolling text here. Your scrolling text here. Your
				scrolling text here. Your scrolling text here. Your scrolling
				text here. Your scrolling text here. Your scrolling text here.
				Your scrolling text here. Your scrolling text here. Your
				...
				scrolling text here. Your scrolling text here. Your scrolling
				text here. Your scrolling text here. Your scrolling text here.
				Your scrolling text here. Your scrolling text here.
			</p>
		</div>
	);
}
