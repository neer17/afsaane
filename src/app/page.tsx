		...
		<div className={styles.page}>
			...
			<section className={styles.heroSection}>
				<div className={styles.textContainer}>
					...
					<span>
						Long description about the product. Long description
						about the product.
					</span>
				</div>
				<Image
			...
			<section className={styles.shippingInfoSection}>
				<span>
					Free shipping on all luggage. Designed by travelers, for
					travelers.
				</span>
				<span>
					We want you to love everything about getting Away—which is
					why we offer free returns and exchanges on unused items for
					the first 100 days.
				</span>
